          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              {branding.support_whatsapp && (
                <a href={`https://wa.me/${branding.support_whatsapp.replace(/[^0-9]/g, '')}`}
                  target="_blank" rel="noopener noreferrer" title="WhatsApp"
                  className="flex h-9 w-9 items-center justify-center rounded-xl border border-border text-muted-foreground hover:text-green-400 hover:border-green-400/40 transition-all hover:scale-110">
