...
function EmojiGifPicker({ onEmoji, onGif, compact = false }: { 
  ...
  // GIFs com URLs diretas de CDN estável (Tenor)
  type Gif = { id: string; title: string; url: string }
  const GIF_DB: Record<string, Gif[]> = {
    '📈 Mercado': [
      {id:'m1',title:'Stonks',url:'https://c.tenor.com/LzBt3U9PZDEAAAAC/stonks-meme.gif'},
      {id:'m2',title:'To the Moon',url:'https://c.tenor.com/6NJk3MEPZHAAAAAC/bitcoin-to-the-moon.gif'},
      {id:'m3',title:'Money Rain',url:'https://c.tenor.com/cBv3OfXexhkAAAAC/money-rain.gif'},
      {id:'m4',title:'Bull Run',url:'https://c.tenor.com/Pz-oWHD4HqIAAAAC/bull-market-bull.gif'},
      {id:'m5',title:'Loss',url:'https://c.tenor.com/KCpRmPUKa2AAAAAC/number-go-down.gif'},
      {id:'m6',title:'Gains',url:'https://c.tenor.com/5O9INzwLGJoAAAAC/gains-money.gif'},
      {id:'m7',title:'Broke',url:'https://c.tenor.com/7NmUvsLmMfQAAAAC/broke-no-money.gif'},
      {id:'m8',title:'Diamond Hands',url:'https://c.tenor.com/RlNuGh3kCb0AAAAC/diamond-hands-hodl.gif'},
      {id:'m9',title:'Bear',url:'https://c.tenor.com/BFXpfBKUTxoAAAAC/bear-market.gif'},
      {id:'m10',title:'Rich',url:'https://c.tenor.com/VPk5DzDFt3AAAAAC/money-rich.gif'},
    ],
    '🚀 Hype': [
      {id:'h1',title:'LFG',url:'https://c.tenor.com/ux-DfpS3jBEAAAAC/lets-go-celebrate.gif'},
      {id:'h2',title:'Hype',url:'https://c.tenor.com/3cMxNPSBtpAAAAAC/excited-hyped.gif'},
      {id:'h3',title:'Yes!',url:'https://c.tenor.com/PqFUAuCxMFkAAAAC/yes-absolutely.gif'},
      {id:'h4',title:'Win',url:'https://c.tenor.com/8Lh8ukJDy5cAAAAC/winner-celebrate.gif'},
      {id:'h5',title:'Amazing',url:'https://c.tenor.com/lPJcSaFGxiMAAAAC/amazing-wow.gif'},
      {id:'h6',title:'Party',url:'https://c.tenor.com/lXr_bGQAk7cAAAAC/party-dance.gif'},
      {id:'h7',title:'Champagne',url:'https://c.tenor.com/m2T0Ep7VH34AAAAC/champagne-celebration.gif'},
      {id:'h8',title:'Dance',url:'https://c.tenor.com/3gBSFrAVdDIAAAAC/dance-happy.gif'},
    ],
    '😂 Memes': [
      {id:'mm1',title:'Bruh',url:'https://c.tenor.com/EAJXwYsNJnkAAAAC/bruh-meme.gif'},
      {id:'mm2',title:'Facepalm',url:'https://c.tenor.com/ZxKVdTWnCcQAAAAC/picard-facepalm.gif'},
      {id:'mm3',title:'Nope',url:'https://c.tenor.com/Kj8LkHm4f_QAAAAC/nope-no.gif'},
      {id:'mm4',title:'Really?',url:'https://c.tenor.com/1IIo0HMQfpkAAAAC/really-seriously.gif'},
      {id:'mm5',title:'SMH',url:'https://c.tenor.com/GsTFKRc2SDQAAAAC/smh-head.gif'},
      {id:'mm6',title:'Crying',url:'https://c.tenor.com/FKdMMi83tgsAAAAC/crying-cry.gif'},
      {id:'mm7',title:'Confused',url:'https://c.tenor.com/GfMy8qC4BPQAAAAC/confused-math.gif'},
      {id:'mm8',title:'Not my problem',url:'https://c.tenor.com/3G0dInBmFpAAAAAC/not-my-problem.gif'},
      {id:'mm9',title:'Shocked',url:'https://c.tenor.com/jyOl8GaNEEsAAAAC/shocked-surprised.gif'},
      {id:'mm10',title:'OK',url:'https://c.tenor.com/TbHx6z9KXDIAAAAC/ok-fine.gif'},
    ],
    '😮 Surpresa': [
      {id:'s1',title:'OMG',url:'https://c.tenor.com/MWFHXdZPtkoAAAAC/omg-oh-my-god.gif'},
      {id:'s2',title:'No way',url:'https://c.tenor.com/nxNBsZoEjzkAAAAC/no-way-really.gif'},
      {id:'s3',title:'Mind blown',url:'https://c.tenor.com/8NTBv-VoH2IAAAAC/mind-blown-explosion.gif'},
      {id:'s4',title:'Wait what',url:'https://c.tenor.com/EBLcCEGP4GAAAAAC/wait-what.gif'},
      {id:'s5',title:'Wow',url:'https://c.tenor.com/2gy0e0pQ3LEAAAAC/wow-face.gif'},
    ],
    '💀 Perdeu': [
      {id:'p1',title:'RIP',url:'https://c.tenor.com/6k8YEMFX-kMAAAAC/rip-rest-in-peace.gif'},
      {id:'p2',title:'Loss',url:'https://c.tenor.com/KCpRmPUKa2AAAAAC/number-go-down.gif'},
      {id:'p3',title:'Sad',url:'https://c.tenor.com/uxMT_-h8mVEAAAAC/sad-cry.gif'},
      {id:'p4',title:'F in chat',url:'https://c.tenor.com/R3KFMCpAHpcAAAAC/f-in-chat.gif'},
      {id:'p5',title:'Crying',url:'https://c.tenor.com/FKdMMi83tgsAAAAC/crying-cry.gif'},
    ],
    '🔥 Futebol': [
      {id:'ft1',title:'Gol',url:'https://c.tenor.com/M7wm7TrKsEgAAAAC/goal-soccer.gif'},
      {id:'ft2',title:'Comemoração',url:'https://c.tenor.com/J-lqhS5rjFQAAAAC/celebrate-football.gif'},
      {id:'ft3',title:'Salto',url:'https://c.tenor.com/w0qT8jJaMuIAAAAC/jump-celebrate.gif'},
      {id:'ft4',title:'Brasil',url:'https://c.tenor.com/3G0dInBmFpAAAAAC/not-my-problem.gif'},
    ],
    '👍 Reações': [
      {id:'r1',title:'Like',url:'https://c.tenor.com/1nSH5S8HQLYAAAAC/like-thumbs-up.gif'},
      {id:'r2',title:'Clap',url:'https://c.tenor.com/y4lQ4vqaUmoAAAAC/clap-slow-clap.gif'},
      {id:'r3',title:'Love',url:'https://c.tenor.com/7FKblOWNlZ4AAAAC/love-heart.gif'},
      {id:'r4',title:'100',url:'https://c.tenor.com/JBNBQR7N2FYAAAAC/100-percent.gif'},
      {id:'r5',title:'Fire',url:'https://c.tenor.com/lmSJHFcNY-AAAAAC/fire-flames.gif'},
    ],
  }
